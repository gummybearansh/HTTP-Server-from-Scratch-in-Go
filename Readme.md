...
./server
```
*The server will immediately bind to `127.0.0.1:2000` and begin accepting traffic.*
...
* *Wildcard* : Automatically triggers a strict `404 Not Found` or `400 Bad Request` protocol response for invalid routing.
